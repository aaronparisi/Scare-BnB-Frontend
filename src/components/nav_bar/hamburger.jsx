...
const Hamburger = (props) => {
  ...
  const faceTheme = {
    ...
    filter:
      props.currentUser == null || props.currentUser.avatar_url == null
        ? "invert(71%) sepia(58%) saturate(591%) hue-rotate(355deg) brightness(90%) contrast(87%)"
        : "none",
  };
  ...
  const genHamburgerFaceClass = () => {
    if (props.currentUser == null) {
      return "nav-link-image hamburger-face";
    } else {
      return "nav-link-image hamburger-avatar";
    }
  };
      ...
      >
        <div className="hamburger-top">
          <img
            src={donut}
            alt="donut"
            className="nav-link-image hamburger-dropdown"
          />
